...
test::testCamera::testCamera()
	: m_Renderer(std::make_unique<renderer>()), width(1920), height(1080),
	  ...
	  camrads{0.0f, 0.0f, 0.0f}, cameraPos(0.0f, 0.0f, 3.0f), cameraFront(0.0f, 0.0f, -1.0f), cameraUp(0.0f, 1.0f, 0.0f), autorotate{false, false, false}, rotatespeed{10.0f, 10.0f, 10.0f},
	  rpm{0.0f, 0.0f, 0.0f}, radians{0.0f, 0.0f, 0.0f}, scale{1.0f, 1.0f, 1.0f}, scale2(1.0f)
{
...
void test::testCamera::onUpdate(timestep deltaTime)
{
	//		m_CameraSpeed = 0.05f * deltaTime.getSeconds(); // adjust accordingly
...
void test::testCamera::onImGuiRender()
{
	...
	ImGui::SliderFloat3("Camera Rotation", camrads, -1920.0f, 1920.0f);
