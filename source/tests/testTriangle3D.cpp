...
test::testTriangle3D::testTriangle3D()
{
	float vertices[] = {
		-0.5f, -0.5f, 0.5f,
		0.5f, -0.5f, 0.5f,
...
void test::testTriangle3D::onUpdate(timestep deltaTime)
{
	test::onUpdate(deltaTime);
}

void test::testTriangle3D::onRender()
{
	// draw
...
void test::testTriangle3D::onImGuiRender()
{
