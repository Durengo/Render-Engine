...
Logging::Logging()
	...
	PTF("\nProgram initialization."); //Print to file.
	std::cout << "Logging instantiated.\n";
	std::cout << logFileName << " Created!\n"; //Print to console. For debugging.
}
...
void Logging::PTF(const std::string& Print1, const std::string& Print2, const std::string& Print3, int Print4) {
	logFile.open(logFileName, std::ios::app);
	logFile << counter << " * " << Print1 << " " << Print2 << " " << Print3 << " " << Print4
		<< "\n--------------------------\n" << "" << Get_Now_Timer() << "--------------------------\n";
	logFile.close();
